...
# 값 변경
df_commercial_change['commercial_district_change_indicator_code'] = df_commercial_change['commercial_district_change_indicator_code'].map({'LL': 0, 'LH': 1, 'HL': 2, 'HH': 3})

# 2021년 1분기부터 2023년 3분기까지의 데이터 추출
df_commercial_change_2021 = df_commercial_change[df_commercial_change['year_code'] == 2021][['year_code', 'quarter_code', 'commercial_district_code', 'commercial_district_change_indicator_code', 'rdi', 'store_density']]
df_commercial_change_2022 = df_commercial_change[df_commercial_change['year_code'] == 2022][['year_code', 'quarter_code', 'commercial_district_code', 'commercial_district_change_indicator_code', 'rdi', 'store_density']]
df_commercial_change_2023 = df_commercial_change[df_commercial_change['year_code'] == 2023][['year_code', 'quarter_code', 'commercial_district_code', 'commercial_district_change_indicator_code', 'rdi', 'store_density']]
...
df_commercial_change.to_csv(output_file_path, index=False, encoding='utf-8-sig')