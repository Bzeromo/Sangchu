...
df_store = df_store.groupby(['year_quarter_code', 'commercial_district_code']).size().reset_index(name='점포수')
...
df_store_2021 = df_store[df_store['년도'] == '2021'][['year_quarter_code', 'commercial_district_code', '점포수', '분기']]
df_store_2022 = df_store[df_store['년도'] == '2022'][['year_quarter_code', 'commercial_district_code', '점포수', '분기']]
df_store_2023 = df_store[df_store['년도'] == '2023'][['year_quarter_code', 'commercial_district_code', '점포수', '분기']]
